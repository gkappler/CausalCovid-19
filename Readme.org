...
Die zu erwartende durchschnittliche Mortalitätsrate von Covid19 in der Gesamtbevölkerung entspricht dem durchschnittlichen kausalen Effekt /ACE = \sum_{z \in Z(\Omega)} P'(Z=z) \eta_{Z=z}/.
